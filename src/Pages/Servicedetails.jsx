...
function Servicedetails() {
  ...
  const {id} = useParams()
    //get service details
     ...
     try {
        const response = await fetch(`${API}/api/admin/service/getServiceById/${id}`,{
            method: "GET"
            })
    ...
    return (
        <>
            <Breadcumbs prevLink="Home" currentLink={servicedetails.title} pageTitle={servicedetails.title} />
                        ...
                        <div className="col-xl-8 col-lg-7">
                            <div className="page-single">
                                <div className="page-img gsap-parallax mb-35">
                                    <img src={`${API}${servicedetails.service_image}`} alt="Service Image" />
                                </div>
                                <div  dangerouslySetInnerHTML={{ __html: servicedetails.full_description }}>
