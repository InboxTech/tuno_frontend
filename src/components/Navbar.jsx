                      ...
                      <div>
                        ...
                        <a href="" className="dropdown-item">
                          <div className="row align-items-center">
                            <div className="col-3">
                              <img
                                src={textToSoundeffect}
                                className="w-100 h-100"
                                alt="text to sound effect"
                              />
                            </div>
                            <div className="col-9">
                              {" "}
                              <h5> Text To Sound Effects </h5>{" "}
                            </div>
                          </div>
                        </a>
                        ...
                        <a href="" className="dropdown-item">
                          <div className="row align-items-center">
                            ...
                            <div className="col-9">
                              ...
                              <p>
                                {" "}
                                Generate and edit long-form audio with precision{" "}
                              </p>
                            </div>
                          </div>
                        </a>
                        ...
                        <a href="" className="dropdown-item">
                          <div className="row align-items-center">
                            ...
                            <div className="col-9">
                              ...
                              <p>
                                {" "}
                                Localize content across 29 languages with AI
                                dubbing{" "}
                              </p>
                            </div>
                          </div>
